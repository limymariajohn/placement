...
<style>
body{
	background-image:url("images/653111826.jpg");
...
<p>Directions (1 to 5) : Read the following information to answer the given questions.</p>
...
<table border="2" width="70%" cellpadding="8" cellspacing="10" align="center">
				...
				<tr><td colspan="2" align="center"><font color="red" style="bold">LOGICAL REASONING</font></td></tr>
				<tr>
...
$s= "INSERT INTO `logical`( `ques`, `optiona`, `optionb`, `optionc`, `optiond`, `ans`) VALUES ('$ques','$optiona', '$optionb','$optionc','$optiond','$ans');";
 mysqli_query($con,$s);
echo "success";
echo $s;
}
