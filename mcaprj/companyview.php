...
<tr><th>cid</th><th>CompanyName</th><th>Industry</th><th>Website</th><th>CurrentRecruitment</th><th>Dateofrecruitment</th><th>place</th></tr>";
  ...
  {
	  $cid=$row[0];
  echo "<tr><td>".$row["cid"]."</td><td>".$row["companyname"]."</td><td>".$row["industry"]."</td><td>".$row["website"]."</td><td>".$row["currentrecruitment"]."</td><td>".$row["dateofre"]."</td><td>".$row["place"]."</td><td><form method='post' action='companydelete.php'><input type='hidden' name='h1' value='$cid'><input type='submit' name='delete' value='Delete'></form></td></tr>";	 
   }
  echo"</table>"
